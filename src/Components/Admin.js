  ...
  render() {
    return (
      <div>
       ...
       <button><NavLink to='/admin/createUser'><i className='material-icons md-10'>how_to_reg</i> <span>New Employee</span></NavLink></button>
       ...
       <button><i className='material-icons md-10'>delete</i> <span> Delete Comments </span></button>
        ...
        <Route path='/admin/createUser' component={Form} />  
      </div>
    );
  }
}
